...
internal static class KeyboardAutoManager
{
	...
	internal static UIView? GetContainerViewController(this UIViewController controller)
	{
	...
	internal static UIViewController? GetViewController(this UIView view)
	{
	...
	internal static UISearchBar? GetTextFieldSearchBar(this UIView view)
	{
		var responder = view as UIResponder;
		while (responder is not null)
		{
			if (responder is UISearchBar searchBar)
				return searchBar;
