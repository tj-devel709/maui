...
namespace Microsoft.Maui.Controls
{
	...
	public sealed class PointerGestureRecognizer : GestureRecognizer
	{
		...
		/// </summary>
		internal void SendPointerEntered(View sender, Func<IElement?, Point?>? getPosition, object? modifiers = null)
		{
			...
			handler?.Invoke(sender, new PointerEventArgs(getPosition, modifiers));
		}

		/// <summary>
		/// For internal use by the .NET MAUI platform.
		/// </summary>
		internal void SendPointerExited(View sender, Func<IElement?, Point?>? getPosition, object? modifiers = null)
		{
